...
/** @addtogroup I2C_duty_cycle
* @{
*/
 
#define I2C_FMDUTYCYCLE_16_9        ((uint16_t)0xC000) /*!< I2C duty Tlow/Thigh = 16/9 */
#define I2C_FMDUTYCYCLE_2           ((uint16_t)0x8000) /*!< I2C duty Tlow/Thigh = 2 */
#define I2C_FMDUTYCYCLE_1           ((uint16_t)0x0000) /*!< I2C duty Tlow/Thigh = 1 */
#define IS_I2C_FM_DUTY_CYCLE(CYCLE) (((CYCLE) == I2C_FMDUTYCYCLE_16_9) || ((CYCLE) == I2C_FMDUTYCYCLE_2) || ((CYCLE) == I2C_FMDUTYCYCLE_1))
/**
 * @}
 */
...
#define I2C_EVT_MASTER_DATA_RECVD_BSF_FLAG ((uint32_t)0x00030044) /* BUSY, MSL ,BSF and RXNE flags */
...
#define I2C_EVT_SLAVE_DATA_RECVD_BSF ((uint32_t)0x00020044) /* BUSY ,BSF and RXNE flags */
/* --EV4  */
...
#define IS_I2C_EVT(EVENT)                                                                                              \
    (((EVENT) == I2C_EVT_SLAVE_SEND_ADDR_MATCHED) || ((EVENT) == I2C_EVT_SLAVE_RECV_ADDR_MATCHED)                      \
     ...
     || ((EVENT) == I2C_EVT_SLAVE_DATA_RECVD_BSF)                                                                      \
     ...
     || ((EVENT) == I2C_EVT_MASTER_DATA_RECVD_BSF_FLAG)                                                                \
