...
#define IS_RTC_ALARM_SEL(ALARM)    (((ALARM) == RTC_A_ALARM) )
#define IS_RTC_ALARM_ENABLE(ALARM) (((ALARM) & (RTC_A_ALARM)) != (uint32_t)RESET)
...
#define RTC_SMOOTH_CALIB_PLUS_PULSES_RESET                                                                            \
    ((uint32_t)0x00000000) /*!<  The number of RTCCLK pulses subbstited                                                \
                        during a 32-second window =   CALM[8:0]. */
#define IS_RTC_SMOOTH_CALIB_PLUS(PLUS)                                                                                 \
    (((PLUS) == RTC_SMOOTH_CALIB_PLUS_PULSES_SET) || ((PLUS) == RTC_SMOOTH_CALIB_PLUS_PULSES_RESET))
...
#define IS_RTC_GET_FLAG(FLAG) (((FLAG) == RTC_FLAG_RECPF) || ((FLAG) == RTC_FLAG_TAMP2F) || \
                               ...
                               ((FLAG) == RTC_FLAG_WTWF) || ((FLAG) == RTC_FLAG_ALAF) || \
...
#define IS_RTC_GET_INT(IT)    (((IT) == RTC_INT_WUT) ||  ((IT) == RTC_INT_ALRA))
