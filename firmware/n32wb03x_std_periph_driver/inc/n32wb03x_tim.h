 ...
 */
#ifndef __N32WB03X_TIM_H__
#define __N32WB03X_TIM_H__
 ...
 * @note   This structure is used with all TIMx except for TIM6.
 */
...
typedef struct
{
    ...
    bool CapCh1FromCompEn;    /*!< channel 1 select capture in from comp if 1, from IOM if
                                Tim1, Tim3 valid*/
    bool CapCh2FromCompEn;    /*!< channel 2 select capture in from comp if 1, from IOM if
                                Tim1, Tim3 valid*/
    bool CapCh3FromCompEn;    /*!< channel 3 select capture in from comp if 1, from IOM if
                                Tim1, Tim3 valid*/
    bool CapEtrClrFromCompEn; /*!< etr clearref select from comp if 1, from ETR IOM if
                                Tim1, Tim3 valid*/
    bool CapEtrSelFromTscEn;  /*!< etr select from TSC if 1, from IOM if Tim1, Tim3 valid*/
 ...
 * @note   This structure is used only with TIM1.
 */
...
#define IsTimAllModule(PERIPH)                                                                                         \
    (((PERIPH) == TIM1) || ((PERIPH) == TIM3) || ((PERIPH) == TIM6))

/* LIST1: TIM 1 */
#define IsTimList1Module(PERIPH) ((PERIPH) == TIM1)

/* LIST2: TIM 1 */
#define IsTimList2Module(PERIPH) ((PERIPH) == TIM1)

/* LIST3: TIM 1, 3 */
#define IsTimList3Module(PERIPH)                                                                                       \
    (((PERIPH) == TIM1) || ((PERIPH) == TIM3))
...
#define TIM_IC_SELECTION_DIRECTTI                                                                                      \
    ((uint16_t)0x0001) /*!< TIM Input 1 or 3 is selected to be                                                   \
                           connected to IC1, IC2, IC3 or IC4, respectively */
#define TIM_IC_SELECTION_INDIRECTTI                                                                                    \
    ((uint16_t)0x0002)                          /*!< TIM Input 1 or 3 is selected to be                          \
                                                    connected to IC2, IC1, IC4 or IC3, respectively. */
#define TIM_IC_SELECTION_TRC ((uint16_t)0x0003) /*!< TIM Input 1 or 3 is selected to be connected to TRC. */
