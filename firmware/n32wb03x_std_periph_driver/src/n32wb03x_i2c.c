...
/* I2C SPE mask */
#define CTRL1_PACKET_ERR_SET   ((uint16_t)0x0001)
#define CTRL1_PACKET_ERR_RESET ((uint16_t)0xFFFE)
...
void I2C_Init(I2C_Module* I2Cx, I2C_InitType* I2C_InitStruct)
{
    ...
    I2Cx->CTRL1 &= CTRL1_PACKET_ERR_RESET;
    /* Reset tmpregister value */
    /* Clear DUTY and CLKCTRL[11:0] bits */
    tmpregister = 0;

    /* DUTY as I2C_FMDUTYCYCLE_1 */
    if(I2C_InitStruct->FmDutyCycle == I2C_FMDUTYCYCLE_1)
    {
        /* duty calculate: Tlow/Thigh = 1 */
        result = (uint16_t)(pclk1 / (I2C_InitStruct->ClkSpeed << 1));
        /* Set DUTY bit */
        result |= I2C_FMDUTYCYCLE_1;
    ...
    /* DUTY as I2C_FMDUTYCYCLE_2 */
    else if (I2C_InitStruct->FmDutyCycle == I2C_FMDUTYCYCLE_2)
    {
        /* duty calculate: Tlow/Thigh = 2 */
        result = (uint16_t)(pclk1 / (I2C_InitStruct->ClkSpeed * 3));
       /* Set DUTY bit */
        result |= I2C_FMDUTYCYCLE_2;
    ...
    /* DUTY as I2C_FMDUTYCYCLE_16_9 */
    else
    {
        /* duty calculate: Tlow/Thigh = 16/9 */
    ...
    else if((I2C_InitStruct->ClkSpeed > 100000) && (I2C_InitStruct->ClkSpeed <= 1000000))
    {
    ...
    I2Cx->CTRL1 |= CTRL1_PACKET_ERR_SET;
...
void I2C_InitStruct(I2C_InitType* I2C_InitStruct)
{
    ...
    I2C_InitStruct->FmDutyCycle = I2C_FMDUTYCYCLE_1;
...
void I2C_ConfigFastModeDutyCycle(I2C_Module* I2Cx, uint16_t FmDutyCycle)
{
    ...
    if (FmDutyCycle != I2C_FMDUTYCYCLE_16_9)
    {
        ...
        I2Cx->CLKCTRL &= I2C_FMDUTYCYCLE_1;
    }
    else
    {
 ...
 *         library (n32wb03x_i2c.h) or to custom values defined by user.
 ...
 *     @arg I2C_EVT_SLAVE_DATA_RECVD_BSF EV2
 ...
 *     @arg I2C_EVT_MASTER_DATA_RECVD_BSF_FLAG EV7
 ...
 *    I2C_Events in n32wb03x_i2c.h file.
 *
