 ...
 * @param TIMx where x can be 1 3 6 to select the TIM peripheral.
 */
 ...
 * @param TIMx where x can be  1 3 to select the TIM peripheral.
 ...
 *         parameters in the TIM_OCInitStruct.
 * @param TIMx where x can be  1 3 to select
 *         the TIM peripheral.
 * @param TIM_OCInitStruct pointer to a OCInitType structure
 *         that contains the configuration information for the specified TIM peripheral.
 */
 ...
 *         parameters in the TIM_OCInitStruct.
 * @param TIMx where x can be  1 or 3 to select the TIM peripheral.
 * @param TIM_OCInitStruct pointer to a OCInitType structure
 *         that contains the configuration information for the specified TIM peripheral.
 */
 ...
 * @param TIMx where x can be 1 3 6 to select the TIMx peripheral.
 ...
 *   - TIM_INT_BREAK is used only with TIM1.
 *   - TIM_INT_COM is used only with TIM1.
 ...
 *   - TIM_EVT_SRC_COM and TIM_EVT_SRC_BREAK are used only with TIM1.
 */
 ...
 * @param TIMx where x can be  1 or 3 to select
 *   the TIM peripheral.
 * @param TIM_DMABase DMA Base address.
 *   This parameter can be one of the following values:
 *     @arg TIM_DMABASE_CTRL1     
 *     @arg TIM_DMABASE_CTRL2     
 *     @arg TIM_DMABASE_SMCTRL    
 *     @arg TIM_DMABASE_DMAINTEN  
 *     @arg TIM_DMABASE_STS       
 *     @arg TIM_DMABASE_EVTGEN    
 *     @arg TIM_DMABASE_CAPCMPMOD1
 *     @arg TIM_DMABASE_CAPCMPMOD2
 *     @arg TIM_DMABASE_CAPCMPEN  
 *     @arg TIM_DMABASE_CNT       
 *     @arg TIM_DMABASE_PSC       
 *     @arg TIM_DMABASE_AR        
 *     @arg TIM_DMABASE_REPCNT    
 *     @arg TIM_DMABASE_CAPCMPDAT1
 *     @arg TIM_DMABASE_CAPCMPDAT2
 *     @arg TIM_DMABASE_CAPCMPDAT3
 *     @arg TIM_DMABASE_CAPCMPDAT4
 *     @arg TIM_DMABASE_BKDT      
 *     @arg TIM_DMABASE_DMACTRL   
 *     @arg TIM_DMABASE_CAPCMPMOD3
 *     @arg TIM_DMABASE_CAPCMPDAT5
 *     @arg TIM_DMABASE_CAPCMPDAT6
 ...
 * @param TIMx where x can be  1, 3, 6
 ...
 * @param TIMx where x can be  1 or 3
 *         to select the TIM peripheral.
 */
 ...
 * @param TIMx where x can be 1, 3 or 6 to select the TIM peripheral.
 ...
 *   - TIM_FLAG_BREAK is used only with TIM1.
 *   - TIM_FLAG_COM is used only with TIM1.
