...
/**
 ****************************************************************************************
 * @addtogroup RDTS Raw Data Transfer Service in 16bit uuid
 * @ingroup PROFILE
 * @brief Raw Data Transfer Service in 16bit uuid
 *****************************************************************************************
 */

/**
 ****************************************************************************************
 * @addtogroup RDTS Raw Data Transfer Service Client in 16bit uuid
 * @ingroup RDTSC
...
struct rdtsc_db_cfg
{
     struct prf_char_def* p_char;
     struct prf_char_desc_def* p_desc;
     uint16_t uuid16;               
...
void rdtsc_16bit_write_data_tx(void *msg, prf_env_t *prf_env, uint8_t conidx,
