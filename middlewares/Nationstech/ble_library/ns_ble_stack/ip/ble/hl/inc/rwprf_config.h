...
#if (BLE_CENTRALH || BLE_PERIPHERAL)
...
/// raw data transfer server server
#if defined(CFG_PRF_RDTSS)
#define BLE_RDTSS_SERVER      1
#else
#define BLE_RDTSS_SERVER      0
#endif // defined(CFG_PRF_RDTSS)

/// raw data transfer Profile client
#if defined(CFG_PRF_RDTSC)
#define BLE_RDTS_CLIENT      1
#else
#define BLE_RDTS_CLIENT      0
#endif // defined(CFG_PRF_RDTSS)

/// raw data transfer server server in 16bit uuid 
#if defined(CFG_PRF_RDTSS_16BIT)
#define BLE_RDTSS_16BIT_SERVER      1
#else
#define BLE_RDTSS_16BIT_SERVER      0
#endif // defined(CFG_PRF_RDTSS_16BIT)

/// raw data transfer Profile client in 16bit uuid
#if defined(CFG_PRF_RDTSC_16BIT)
#define BLE_RDTS_16BIT_CLIENT      1
#else
#define BLE_RDTS_16BIT_CLIENT      0
#endif // defined(CFG_PRF_RDTSC_16BIT)
...
#define BLE_RDTS_ENABLE (BLE_RDTSS_SERVER || BLE_RDTSS_16BIT_SERVER )
...
/// BLE_CLIENT_PRF indicates if at least one client profile is present
        ...
        || BLE_CGM_CLIENT || BLE_DBG_THPP || BLE_RDTS_CLIENT || BLE_ANC_CLIENT || BLE_RDTS_16BIT_CLIENT)
...
#elif (BLE_OBSERVERH || BLE_BROADCASTER)
/// Proximity Profile Monitor Role
#define BLE_PROX_MONITOR            0
/// Proximity Profile Reporter Role
#define BLE_PROX_REPORTER           0
...
/// Profile Client
#define BLE_CLIENT_PRF              0
#endif //(BLE_OBSERVERH || BLE_BROADCASTER)
