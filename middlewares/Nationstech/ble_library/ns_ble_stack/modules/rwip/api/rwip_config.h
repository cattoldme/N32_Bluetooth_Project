 ...
 ****************************************************************************************
 */
#define  BLE_NB_PROFILES    10
#define  BLE_PROFILES       BLE_NB_PROFILES
#define  CFG_HOST  
#define  CFG_APP
#define  CFG_PRF
#define  CFG_APP_PRF        1
...
#define BLE_OBSERVERH               1
#define BLE_CENTRALH                1
            
#define CFG_RAL                     2     //TODO VAR
#define CFG_ACT                     4
#define CFG_CON                     4
            
            
#define CFG_CON_CTE_REQ             1
#define CFG_CON_CTE_RSP             1
#define CFG_CONLESS_CTE_TX          1
#define CFG_CONLESS_CTE_RX          1
#define CFG_AOD                     1
#define CFG_AOA                     1
...
#if (BLE_CONNECTION_MAX > BLE_ACTIVITY_MAX)  // TODO_CHECK 
...
#if defined(CFG_AODH)
    #define BLE_AODH                        (1)
#else // defined(CFG_AODH)
    #define BLE_AODH                        (0)    
#endif // defined(CFG_AODH)
...
#if defined(CFG_AOAH)
    #define BLE_AOAH                        (1)    
#else // defined(CFG_AOAH)
    #define BLE_AOAH                        (0)    
#endif // defined(CFG_AOAH)
...
#if defined(CFG_PRF)
#include "rwprf_config.h"     // Application configuration
#endif // defined(CFG_APP)
...
#define RWIP_MINIMUM_SLEEP_TIME               16//(10)
